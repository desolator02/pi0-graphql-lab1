This docker image based on arm/v6 arch and is meant to run on rpi. 
Content of the lab is provided by Davide Cioccia <https://github.com/david3107/graphql-security-labs.git>
Thanks a lot Davide.
